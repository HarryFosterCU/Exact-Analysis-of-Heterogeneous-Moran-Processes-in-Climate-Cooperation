...
df_compare = df_compare.drop(columns=["alpha_i_in_imispection", "i_in_imispection", "alpha_i_in_fermi", "i_in_fermi"])
...
df_compare["winner_margin"] = np.abs(df_compare["p_C_in_imispection"] - df_compare["p_C_in_fermi"])
