...
df_compare = df_compare.drop(columns=["alpha_i_in_fermi", "i_in_fermi", "alpha_i_in_introspection", "i_in_introspection"])
...
df_compare["winner_margin"] = np.abs(df_compare["p_C_in_fermi"] - df_compare["p_C_in_introspection"])
