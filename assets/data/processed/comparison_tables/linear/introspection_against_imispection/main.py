...
df_imispection = pd.read_csv(root_path / "assets/data/raw/linear_population_imispection/main.csv")
df_introspection = pd.read_csv(root_path / "assets/data/raw/linear_population_introspection/main.csv")
