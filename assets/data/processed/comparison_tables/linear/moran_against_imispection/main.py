...
df_compare = df_compare.drop(columns=["alpha_i_in_moran", "i_in_moran", "alpha_i_in_imispection", "i_in_imispection"])
...
df_compare["winner_margin"] = np.abs(df_compare["p_C_in_moran"] - df_compare["p_C_in_imispection"])
