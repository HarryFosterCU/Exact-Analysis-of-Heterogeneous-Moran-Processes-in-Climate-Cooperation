...
df = pd.DataFrame(columns=["UID","alpha_i", "i", "mutant_alpha", "N", "r", "beta", "p_C", "process", "population", "stochastic"])
                    ...
                    for repetitions in range(200):
                        ...
                        for first_contribution in np.unique(alphas):
                            ...
                            for i, alpha in enumerate(alphas):
                                row = [id, alpha, i, first_contribution, N, r, choice_intensity, p_C, "fermi", "binomial", True]
                                data.append(row)
