...
df = pd.DataFrame(columns=["UID", "alpha_i", "i", "mutant_alpha", "N", "n", "r", "epsilon", "beta", "p_C", "process", "population", "stochastic"])
                        ...
                        for choice_intensity in np.linspace(0,2,30):
                            ...
                            for first_contribution in np.unique(alphas):
                                ...
                                for i, alpha in enumerate(alphas):
                                    row = [id, alpha, i, first_contribution, N, n,r, selection_intensity, choice_intensity, p_C, "introspective imitation", "binomial", False]
                                    data.append(row)
