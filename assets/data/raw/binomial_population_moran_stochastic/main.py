...
df = pd.DataFrame(columns=["UID","alpha_i", "i", "mutant_alpha", "N","n", "r", "epsilon","p_C", "process", "population", "stochastic"])
                            ...
                            for selection_intensity in np.linspace(0,(1/max(alphas)) * 0.99,30):
                                ...
                                for first_contribution in np.unique(alphas):
                                    ...
                                    for i, alpha in enumerate(alphas):
                                        row = [id, alpha, i, first_contribution, N, n,r, selection_intensity,p_C, "moran", "binomial", True]
                                        data.append(row)
