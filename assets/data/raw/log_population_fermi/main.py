...
df = pd.DataFrame(columns=["UID", "alpha_i", "i", "first_alpha", "N", "r", "beta", "p_C", "process", "population", "stochastic"])
            ...
            for choice_intensity in choice_intensity_range:
                ...
                for first_contribution in np.unique(alphas):
                    ...
                    for i, alpha in enumerate(alphas):
                        row = [id, alpha, i, first_contribution, N, r, choice_intensity, p_C, "fermi", "log", False]
                        data.append(row)
