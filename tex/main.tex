...
Another type of mapping that we can use is the ``Affine-linear mapping". In this, for some tunable \(\epsilon\), we take the following:\\
...
\begin{figure}[!h]
    \centering
    \includegraphics[width=1\linewidth]{Homogeneous_Fixation_Probabilities_Both.png}
