...
\node at (7,4.5) {\textbf{Selection \(\propto f\)}};
\node at (12,4.5) {\textbf{Update}};

\node at (7, 5.5) {\textbf{Moran Process}};
...
\begin{scope}[shift={(6.15,2)}, scale=0.75]
    ...
    % outline
    \begin{scope}[shift={(2.75,0)}, scale=0.55]
...
\node at (7, 5.5) {\textbf{Fermi Imitation Dynamics}};
...
\includegraphics[width=0.45\textwidth]{./src/img/absorption_probabilities_N_eq_2_homogeneous_fermi_r_alpha/main.pdf}
\hfill
...
\caption{Four images in a 2×2 arrangement.}
\end{figure}
