...
We can also look at how different population sizes affect the overall
probability of cooperation.

\begin{figure}[!h]
    \centering
\includegraphics[width=1\linewidth]{./Figures/Homogeneous_Fixation_Probabilities_N/Main.png}
    \caption{Fixation probabilities in the homogeneous case. Here we take }
    \label{fig:Homogeneous_Fixation_Probability_N}
\end{figure}
