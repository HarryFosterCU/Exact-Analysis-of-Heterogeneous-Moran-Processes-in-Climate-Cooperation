...
\begin{equation}
    \phi(f_{i}(\textbf{a}) - f_{j}(\textbf{a})) = \frac{1}{1 + \exp({\frac{f_{i}(\textbf{a}) - f_{j}(\textbf{a})) }{\beta}})}
\end{equation}
...
\begin{equation}
\begin{bmatrix}
1 & 0 & 0 & 0\\\frac{1}{\left(2e^{\frac{- f_{1}{\left(\textbf{b} \right)} + f_{2}{\left(\textbf{b} \right)}}{\beta}} + 1\right)} & 0.5 & 0 & \frac{1}{\left(2e^{\frac{f_{1}{\left(\textbf{b} \right)} - f_{2}{\left(\textbf{b} \right)}}{\beta}} + 1\right)}\\\frac{1}{\left(2e^{\frac{f_{1}{\left(\textbf{c} \right)} - f_{2}{\left(\textbf{c} \right)}}{\beta}} + 1\right)} & 0 & 0.5 & \frac{1}{\left(2e^{\frac{- f_{1}{\left(\textbf{c} \right)} + f_{2}{\left(\textbf{c} \right)}}{\beta}} + 1\right)}\\0 & 0 & 0 & 1
\end{bmatrix}
\end{equation}
\end{center}
...
\begin{enumerate}
    ...
    \item Another player \(a_j\) in the population is chosen at random to have their strategy considered
    \item The focal player changes their strategy with probability \(\phi(\Delta(f_{I(\textbf{a,b})})\)
\end{enumerate}

Let \(\kappa(a_i)\) denote the number of players in \(a_{-i}\) with the same action type as \(a_i\). 
We can define a transition matrix \(T\) of an introspective imitation process as follows:

\begin{equation}
T_{\textbf{a,b}} = p_{a_{I(\textbf{a,b})}\to b_{I(\textbf{a,b})}}(a_{-j}) = \begin{cases}
    \frac{\kappa(b_{I(a,b)})}{N(N-1)}\phi(\Delta(f_{I(\textbf{a,b})}) & \text{if \textbf{b}}\in \text{Neb(\textbf{a})}\\
    0 & \text{if \textbf{b}}\notin \text{Neb(\textbf{a}) and \textbf{a}} \neq \textbf{b}\\
...
\begin{equation}
\begin{bmatrix}
\frac{e^{\frac{f_{1}{\left(b \right)} - f_{1}{\left(d \right)}}{\beta}} + 1}{e^{\frac{f_{1}{\left(b \right)} - f_{1}{\left(d \right)}}{\beta}} +  e^{\frac{- f_{2}{\left(a \right)} + f_{2}{\left(b \right)}}{\beta}} + 2} & \frac{e^{\frac{- f_{2}{\left(a \right)} + f_{2}{\left(b \right)}}{\beta}} + 1}{e^{\frac{f_{1}{\left(b \right)} - f_{1}{\left(d \right)}}{\beta}} + e^{\frac{- f_{2}{\left(a \right)} + f_{2}{\left(b \right)}}{\beta}} + 2}\\\frac{e^{\frac{f_{2}{\left(c \right)} - f_{2}{\left(d \right)}}{\beta}} + 1}{e^{\frac{- f_{1}{\left(a \right)} + f_{1}{\left(c \right)}}{\beta}} + e^{\frac{f_{2}{\left(c \right)} - f_{2}{\left(d \right)}}{\beta}} + 2} & \frac{e^{\frac{- f_{1}{\left(a \right)} + f_{1}{\left(c \right)}}{\beta}} + 1}{e^{\frac{- f_{1}{\left(a \right)} + f_{1}{\left(c \right)}}{\beta}} + e^{\frac{f_{2}{\left(c \right)} - f_{2}{\left(d \right)}}{\beta}} + 2}
\end{bmatrix}
\end{equation}
\end{large}
\end{center}
...
\begin{table}[!h]
    ...
    \hline
         ...
         \hline
         &\\
         TODO&$\displaystyle \left[\begin{matrix}\frac{ e^{\frac{\alpha \left(2 - r\right)}{2 \beta}} + 1)}{ e^{\frac{\alpha \left(2 - r\right)}{2 \beta}} +  e^{\frac{\alpha \left(r - 2\right)}{2 \beta}} + 1} & \frac{e^{\frac{\alpha \left(r - 2\right)}{2 \beta}} + 1}{e^{\frac{\alpha \left(2 - r\right)}{2 \beta}} + e^{\frac{\alpha \left(r - 2\right)}{2 \beta}} + 1}\\\frac{e^{\frac{\alpha \left(2 - r\right)}{2 \beta}} + 1}{e^{\frac{\alpha \left(2 - r\right)}{2 \beta}} + e^{\frac{\alpha \left(r - 2\right)}{2 \beta}} + 1} & \frac{e^{\frac{\alpha \left(r - 2\right)}{2 \beta}} + 1}{e^{\frac{\alpha \left(2 - r\right)}{2 \beta}} + e^{\frac{\alpha \left(r - 2\right)}{2 \beta}} + 1}\end{matrix}\right]$\\
         &\\
         \hline
    \end{tabular}
